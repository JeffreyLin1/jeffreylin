            ...
            <div className="space-y-12 w-full lg:max-w-4xl">
              ...
              <div className="relative">
                <div className="border-b border-slate-200 pb-8">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-3">
                          <h2 className="text-lg sm:text-2xl font-bold text-slate-800">Shopify</h2>
                          <span className="text-sm text-slate-500 hidden sm:inline">Sept 2025 - Dec 2025</span>
                        </div>
                      </div>
                      
                      <p className="text-base text-slate-600 italic mb-1 sm:mb-2">Software Engineering Intern</p>
                      <span className="text-xs text-slate-500 sm:hidden">Sept 2025 - Dec 2025</span>
                  ...
                  <div className="block sm:hidden text-base text-slate-700">
                    <p>Working on assistants team, contributing to Sidekick AI</p>
                    <p>Building a tool to generate synthetic data for LLM training</p>
                  </div>
                </div>
                ...
                <div className="border-b border-slate-200 pb-8">
                  <div className="flex flex-row gap-4 sm:gap-6 mb-4 sm:mb-0">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-3">
                          <h2 className="text-lg sm:text-2xl font-bold text-slate-800">Agentnoon (YC W22) - Acquired by Dayforce</h2>
                          <span className="text-sm text-slate-500 hidden sm:inline">Jan 2025 - Apr 2025</span>
                        </div>
                      </div>
                      
                      <p className="text-base text-slate-600 italic mb-1 sm:mb-2">Software Engineering Intern</p>
                      <span className="text-xs text-slate-500 sm:hidden">Jan 2025 - Apr 2025</span>
                ...
                <div className="pb-6">
                  <div className="flex flex-row gap-4 sm:gap-6 mb-4 sm:mb-0">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-3">
                          <h2 className="text-lg sm:text-2xl font-bold text-slate-800">The Mirror</h2>
                          <span className="text-sm text-slate-500 hidden sm:inline">2016 - 2024</span>
                        </div>
                      </div>
                      
                      <p className="text-base text-slate-600 italic mb-1 sm:mb-2">Paper Boy</p>
                      <span className="text-xs text-slate-500 sm:hidden">2016 - 2024</span>
